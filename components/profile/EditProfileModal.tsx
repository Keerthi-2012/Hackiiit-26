            ...
            <Stack direction="row" spacing={1} sx={{ flexWrap: 'wrap' }} useFlexGap>
              {INTERESTS.map((tag: string) => (
                <Chip
                  ...
                  variant={selected.includes(tag) ? 'filled' : 'outlined'}
                  sx={{
                    backgroundColor: selected.includes(tag) ? '#4facfe' : 'transparent',
                    color: selected.includes(tag) ? '#0f172a' : '#00f2fe',
                    fontWeight: 600,
                    cursor: saving ? 'not-allowed' : 'pointer',
                    borderColor: '#4facfe',
                    height: 32,
                    transition: 'all 0.2s ease',
                    '&:hover': {
                      backgroundColor: selected.includes(tag) ? '#4facfe' : 'rgba(79, 172, 254, 0.15)',
                      opacity: saving ? 0.6 : 1,
                      transform: saving ? 'none' : 'scale(1.05)',
                      borderColor: '#00f2fe',
                    },
